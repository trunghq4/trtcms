            ...
            <div class="col-md-9">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                  ...
                  <input id="{{$items->name}}" class="form-control col-md-7 col-xs-12" name="{{$items->name}}" type="text" value="">
                  @elseif($items->display_type == 1)
                  <input type="checkbox" name="{{$items->name}}" id="{{$items->name}}" class="flat">
                  @elseif($items->display_type == 2)
                  <input id="{{$items->name}}" class="form-control col-md-7 col-xs-12" name="{{$items->name}}" type="number" value="">
                  ...
                  <input id="fileUpload" class="form-control col-md-7 col-xs-12" name="{{$items->name}}" type="file" value="">
                  <div class="clearfix"></div>
                  <div id="image-holder" class="col-md-3 col-xs-12"></div>
                  @elseif($items->display_type == 6)
                  <textarea class="form-control" id="{{$items->name}}" name="{{$items->name}}"></textarea>
