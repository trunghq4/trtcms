...
class BaoKimModel extends Model {

	// URL checkout của baokim.vn
	private $baokim_url = 'https://www.baokim.vn/payment/customize_payment/order';

	// Mã merchante site
	private $merchant_id = '28590';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = '9cb3e26847bebab9'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
